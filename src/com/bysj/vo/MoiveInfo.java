...
public class MoiveInfo {
	...
	public MoiveInfo(String showTypeName, String language, String hallName) {
		super();
		ShowTypeName = showTypeName;
		Language = language;
		HallName = hallName;
	...
	public MoiveInfo(Integer seqNo, Object showTime, String showTypeName,
			String language, String hallName, Integer seatnum,
			Integer settlementPrice, Integer unionCharge) {
		super();
		SeqNo = seqNo;
